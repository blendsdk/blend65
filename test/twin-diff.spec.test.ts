  ...
  it(
    ...
    () => {
      ...
      try {
        ...
        // The corpus is complete: every committed golden has its twin, so
        // the unpaired list is pinned EMPTY — a new golden without a twin
        // must fail here until it is paired.
