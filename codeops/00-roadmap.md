...
|---------|---------|---------------|----------|--------|--------------|
| blend65-ri | [→](features/blend65-ri/00-roadmap.md) | **RD-18** codegen language completion in flight — Slices 3a–8a ✅ (8a hardware VICE-verified), 8b data (last) needs `make_plan` + carries RD-18 closure; RD-01..RD-17 ✅, RD-13/RD-14 queued | 18/20 | 🔄 | 2026-07-17 |
