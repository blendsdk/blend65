...
> **Created**: 2026-07-17 · **Last Updated**: 2026-07-21 (RD-05 ✅ closed; RD-03 ✅ closed; RD-13 symbolic-address slice drafted, preflighted and **planned** — RD gate on AR #78–#82, preflight runtime AR #83–#87, plan gate on AR #88–#95; ambiguity register at 56 items, all resolved)
...
| **RD-13** | [Symbolic address arithmetic](RD-13-symbolic-address-arithmetic.md) | An address is a link-time constant the assembler folds for free; the compiler materializes it at runtime instead. Makes `hi(&X)`/`lo(&X)` one instruction, folds `lo(&X / 2^k)` and `lo(&X >> k)` to an ACME expression instead of `JSR __rt_div16` / `E90001`, and stops `W10172` firing where the frozen spec forbids it. Grammar-free; unblocks RD-15 ([#58](https://github.com/blendsdk/blend65/issues/58), symbolic slice only) — 🔎 preflighted 2026-07-20 (27 findings applied; spun off [#70](https://github.com/blendsdk/blend65/issues/70), [#71](https://github.com/blendsdk/blend65/issues/71)) · 📋 [plan](../plans/rd-13-symbolic-address-arithmetic/00-index.md) created 2026-07-21 (5 phases / 50 tasks, gate passed on AR #88–#95) | RD-01, RD-02, RD-03 |
