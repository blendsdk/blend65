...
| RD-05 | Block layout: fall-through elision + jump threading ([#51](https://github.com/blendsdk/blend65/issues/51)) | [RD](requirements/RD-05-block-layout.md) | — | RD Preflighted | 🔎 | 2026-07-19 | B1 — twin-idiom acceptance (AR #20) + [#65](https://github.com/blendsdk/blend65/issues/65) branch range written as ACs; gate passed (AR #26–#33); preflight 32 findings all resolved (10 major) — next: `make_plan` |
