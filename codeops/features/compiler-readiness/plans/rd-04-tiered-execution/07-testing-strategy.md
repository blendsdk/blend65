...
| `packages/readiness/src/execution-publication.spec.test.ts` plus independent `test-fixtures/execution-publication-spec-fixture.ts` | ST-45–ST-50, readiness-owned portion of ST-55 and passive transaction/reconciliation portion of ST-57 | Phase 6 readiness production |
| `packages/readiness-execution/src/execution-publication-catalog.spec.test.ts` plus independent `test-fixtures/execution-publication-catalog-spec-fixture.ts` | readiness-execution-owned portion of ST-55, ST-56 and public live-gated select/old→new→old portion of ST-57 | Phase 6 live-catalog production |
