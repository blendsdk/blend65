...
| RD-08 | Complete C64 rule models, generator coverage and oracle-contract expansion | [RD-08](requirements/RD-08-complete-c64-rule-coverage.md) | [Plan](plans/rd-08-complete-c64-rule-coverage/00-index.md) | Deferred (was: Executing) | ⏸️ | 2026-09-04 | Explicitly paused after 21/62 tasks for the domain-skill-first course correction and read-only compiler recovery audit; the green WIP checkpoint is preserved at `14d9f1f` |
