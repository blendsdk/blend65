...
| RD-08 | Complete C64 rule models, generator coverage and oracle-contract expansion | — | — | Backlog | ⬜ | 2026-09-02 | **Recommended next priority**; depends on RD-02, RD-03 and owns arrays, nested calls, branches, loops, loop-unrolling relations and the remaining 2,103 rule models |
