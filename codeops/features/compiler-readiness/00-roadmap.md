...
| RD-04 | Tiered compiler, ACME and VICE execution | [RD-04](requirements/RD-04-tiered-execution.md) | [Plan](plans/rd-04-tiered-execution/00-index.md) | Executing | 🔄 | 2026-08-23 | depends on RD-02, RD-03; 59/88 tasks; Phase 5 runtime observation and local authority proof complete; Phase 6 child publication and composite resolution next |
