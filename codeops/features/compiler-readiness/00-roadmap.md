...
| RD-04 | Tiered compiler, ACME and VICE execution | [RD-04](requirements/RD-04-tiered-execution.md) | [Plan](plans/rd-04-tiered-execution/00-index.md) | Executing | 🔄 | 2026-08-22 | depends on RD-02, RD-03; 48/88 tasks; Phase 4 complete and exact full gate green; next: Phase 5 runtime observation and local authority proof |
