...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend](plans/rd-03-frontend-first/00-index.md) · [Pipeline completion](plans/rd-03-pipeline-completion/00-index.md) | Executing | 🔄 | 2026-09-20 | Frontend complete (64/64). Pipeline completion Phases 1–2 are complete (20/79): frozen M1 inputs, selected profile/raw assets, semantic CFG, root-based whole-program closure, effects and exact liveness are green. Phase 3 SFA and ABI closure is next. SpritePad stays in RD-06; Windows evidence stays in RD-10. |
