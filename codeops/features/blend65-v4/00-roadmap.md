...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 aggregate ABI/SFA and equal-contract expert checks are green (46/99), with independent phase review next. Native Windows remains deferred to RD-10. |
