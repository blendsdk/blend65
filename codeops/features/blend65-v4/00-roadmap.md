...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phase 1 committed; Phase 2 is 20/99 verified. Frontend, semantic, and direct VICE scalar/flow cases pass. Remaining scalar machine operators and later phases are still open. Native Windows remains deferred to RD-10. |
