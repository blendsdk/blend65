...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 aggregate values, caller-owned returns and checked borrowed-array counts verified (40/99). SFA qualification continues. Native Windows remains deferred to RD-10. |
