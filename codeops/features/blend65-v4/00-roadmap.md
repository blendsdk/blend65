...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 implementation and aggregate ABI specification cases are green (44/99). SFA implementation tests and expert qualification continue. Native Windows remains deferred to RD-10. |
