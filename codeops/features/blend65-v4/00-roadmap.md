...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 implementation, aggregate ABI specification and SFA lifetime/closure tests are green (45/99). Expert qualification continues. Native Windows remains deferred to RD-10. |
