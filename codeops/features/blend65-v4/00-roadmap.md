...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phase 1 committed; 23/99 tasks verified. Phase 2 scalar/control specification and implementation cases pass, including real VICE arithmetic and checked division. Expert-output evidence remains before the Phase 2 checkpoint; later phases remain open. Native Windows remains deferred to RD-10. |
