...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phase 1 is 12/99 verified; user-approved review fixes and one clean re-review are complete. Install, build, typecheck and 1,194 tests pass. Native Windows remains deferred to RD-10. |
