...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–2 complete; 24/99 tasks verified. Scalar/control, VICE and expert-output cases pass; independent quality review is closed. Phase 3 aggregates/addresses is next. Native Windows remains deferred to RD-10. |
