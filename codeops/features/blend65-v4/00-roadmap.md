...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend](plans/rd-03-frontend-first/00-index.md) · [Pipeline completion](plans/rd-03-pipeline-completion/00-index.md) | Executing | 🔄 | 2026-09-20 | Frontend complete (64/64). Pipeline completion Phase 1 is complete (12/79): frozen M1 inputs, the selected frontend profile and the bounded raw asset path are green. Phase 2 semantic CFG and whole-program closure is next. SpritePad stays in RD-06; Windows evidence stays in RD-10. |
