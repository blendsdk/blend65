...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Executing | 🔄 | 2026-09-19 | Phases 1–3 lexer/parser/module graph qualified; phase 4 scalar expressions, direct calls and structured flow next, using the Linux foundation without a DEF-1 compiler-work block |
