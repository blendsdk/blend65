...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Plan Created | 📋 | 2026-09-23 | Nine-phase plan ready (99 tasks); RD-03 Linux implementation complete; native Windows evidence remains deferred to RD-10 |
