...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 aggregate values and caller-owned returns verified (39/99). Array-count ABI and SFA qualification continue. Native Windows remains deferred to RD-10. |
