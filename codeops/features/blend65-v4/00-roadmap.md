...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | ⛔ Blocked (was: Executing) | ⛔ | 2026-09-26 | Waiting on DEF-11: one old fixed-size raw-asset test conflicts with frozen variable-length raw embed. Phases 1–6 and 74/99 tasks are verified; CPU controls, status-stack proof and BCD pass frontend, assembly and VICE checks. Whole-program intrinsic resource accounting follows embed. AR-P19 moved only source-visible profile facts to RD-05. Phase 6 evidence/stack precision notes remain for RD-04 qualification. Unsafe NMI sinks (AR-P16) and handler-side IRQ vector updates (AR-P17) reject with E10245; RD-05 owns both valid forms. Phase 5 parity debt remains tracked in [#83](https://github.com/blendsdk/blend65/issues/83) and [#84](https://github.com/blendsdk/blend65/issues/84); Phase 6 meet-only debt in [#85](https://github.com/blendsdk/blend65/issues/85). Native Windows remains deferred to RD-10. |
| ↳ DEF-11 | Obsolete fixed-size raw-asset test authority | — | [Decision](plans/rd-04-language-completion/00-ambiguity-register.md) | Deferred | ⏸️ | 2026-09-26 | AR-P20: approve the narrow update to the old 512-byte-only expectation; keep the frozen variable-length rule and all safety checks. |
