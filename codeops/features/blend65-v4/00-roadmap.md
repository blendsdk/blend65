...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-26 | Phases 1–6 and 74/99 tasks verified. Five CPU controls, function-local status-stack proof, and byte/word packed BCD pass frontend, assembly and VICE checks. Contained raw embed is next; whole-program intrinsic resource accounting follows. AR-P19 moved only source-visible profile facts to RD-05. Phase 6 evidence/stack precision notes remain for RD-04 qualification. Unsafe NMI sinks (AR-P16) and handler-side IRQ vector updates (AR-P17) reject with E10245; RD-05 owns both valid forms. Phase 5 parity debt remains tracked in [#83](https://github.com/blendsdk/blend65/issues/83) and [#84](https://github.com/blendsdk/blend65/issues/84); Phase 6 meet-only debt in [#85](https://github.com/blendsdk/blend65/issues/85). Native Windows remains deferred to RD-10. |
