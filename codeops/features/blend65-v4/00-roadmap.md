...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 nested-construction corrections pass full verification (46/99). [Issue #82](https://github.com/blendsdk/blend65/issues/82) tracks a remaining expert-output parity defect before Phase 5. Native Windows remains deferred to RD-10. |
