...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend](plans/rd-03-frontend-first/00-index.md) · [Pipeline completion](plans/rd-03-pipeline-completion/00-index.md) | Executing | 🔄 | 2026-09-20 | Frontend complete (64/64). The minimum-sufficient remaining plan is ready for preflight: raw sprite, backend/CFG/SFA, lowering, packaging, CLI/editor, ACME and VICE. SpritePad stays in RD-06. Linux work is not blocked by Windows evidence. |
