...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Executing | 🔄 | 2026-09-19 | Asset-independent frontend plan complete (64/64). Next plan owns authentic SpritePad evidence, profiles/assets, backend/CFG/SFA, lowering, packaging, CLI/editor consumers, ACME and VICE acceptance. Linux work is not blocked by DEF-1. |
