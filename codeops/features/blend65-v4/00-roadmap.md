...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Plan Created | 📋 | 2026-09-18 | Partial frontend plan only; preflight next. Full M1 still needs RD-02, qualified SpritePad input and remaining pipeline planning. |
