...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Plan Preflighted | 🔬 | 2026-09-18 | Partial frontend [preflight](plans/rd-03-frontend-first/00-preflight-report.md) passed; ready for lexer specification tests. Full M1 still needs RD-02, qualified SpritePad input and remaining pipeline planning. |
