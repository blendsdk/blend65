...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | — | ⛔ Blocked (was: RD Preflighted) | ⛔ | 2026-09-18 | Frontend-first planning approved; waiting on DEF-2. Full M1 still needs RD-02 and qualified SpritePad input. |
| ↳ DEF-2 | Parser syntax diagnostic authority decision | — | [Discovery](plans/rd-03-frontend-first/00-ambiguity-register.md) | Deferred | ⏸️ | 2026-09-18 | Owner: user rules on AR-P3; agent resumes planning. No full plan exists yet. |
