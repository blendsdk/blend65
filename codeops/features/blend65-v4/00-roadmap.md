...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | Executing | 🔄 | 2026-09-24 | Phases 1–4 verified (46/99); 300-byte nested copy measures 103 bytes against the 104-byte expert reference. Phase 5 is next. [Issue #82](https://github.com/blendsdk/blend65/issues/82) remains open administratively after its byte-gap fix. Native Windows remains deferred to RD-10. |
