...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phase 1 committed; 22/99 tasks verified. Phase 2 scalar/control specification cases, including real VICE arithmetic and checked division, pass. Implementation hardening and expert-output evidence remain before the Phase 2 checkpoint; later phases remain open. Native Windows remains deferred to RD-10. |
