...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | ⛔ Blocked (Phase 4 review) | ⛔ | 2026-09-24 | Phases 1–3 verified; Phase 4 implementation checks are green (46/99), but independent review found four major correctness/size findings awaiting a user ruling and correction. Phase 5 has not started. Native Windows remains deferred to RD-10. |
