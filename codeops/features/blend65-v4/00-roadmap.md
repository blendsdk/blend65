...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Executing | 🔄 | 2026-09-19 | Phases 1–5 qualified; Phase 6 service/effects acceptance next. Linux work is not blocked by DEF-1. |
