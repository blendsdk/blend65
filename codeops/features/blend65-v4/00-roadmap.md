...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified (36/99); Phase 3 approved fixes passed full verification and independent fix-scoped review. Aggregate/address ACME, VICE and expert cases pass. Phase 4 aggregate ABI/SFA is next. Native Windows remains deferred to RD-10. |
