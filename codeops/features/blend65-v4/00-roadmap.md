...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phase 1 committed; 24/99 tasks verified. Phase 2 scalar/control and VICE cases pass. Independent review fixes are green; division-result reuse and cross-function helper sharing remain before Phase 2 closeout. Later phases remain open. Native Windows remains deferred to RD-10. |
