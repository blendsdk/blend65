...
| RD-04 | Complete Language and Correct Unoptimized Compiler | [RD-04](requirements/RD-04-complete-language-correct-unoptimized-compiler.md) | [Plan](plans/rd-04-language-completion/00-index.md) | Executing | 🔄 | 2026-09-24 | Phases 1–3 verified; Phase 4 implementation checks are green (46/99). User approved correction of four independent-review findings; fix verification and one scoped re-review precede Phase 5. Native Windows remains deferred to RD-10. |
