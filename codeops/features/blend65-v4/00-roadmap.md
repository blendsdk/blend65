...
| RD-03 | Playable M1 Complete Pipeline | [RD-03](requirements/RD-03-playable-m1-complete-pipeline.md) | [Frontend plan](plans/rd-03-frontend-first/00-index.md) | Executing | 🔄 | 2026-09-19 | Phase 1 lexer qualified and phase 2 parsing next, using the Linux foundation without a DEF-1 compiler-work block |
