...
| ST-23 | Constant/type facts `byte($1234)`, `sbyte($80)`, `sword(sbyte($80))`, typed signed `-128 >> 1`, `-128 >> 8`, unsigned `128 >> 8`; separate `byte(true)`; plus division/remainder parameter rows below | Values 52, -128, -128, -64, -1, 0; `byte($1234)` emits W10101, `Narrowing cast from 'word' to 'byte' truncates 4660 to 52`, at the complete cast span; wide-shift cases emit W10174; Boolean cast emits E10086. Required division/remainder results and diagnostic/runtime distinctions below also pass. | Ch 02 TS-12/19/20; Ch 04 §§3.3,4; PF-003 |
