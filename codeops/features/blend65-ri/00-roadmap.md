...
>
> **Last Updated**: 2026-07-10 (**RD-18 Slice 5a 🔄 Executing** — exec_plan started on
> `plans/rd-18-slice-5a-functions-calls/` (6 phases / 46 tasks; Phase 0 = data-region
> relocation `$0800`→`$2000` + mandatory overlap guard, then call semantics → SFA wiring →
> call codegen → three-part acceptance → rollout).
