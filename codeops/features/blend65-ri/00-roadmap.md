...
>
> **Last Updated**: 2026-07-05 (**RD-18 Slice 3a ✅ COMPLETE** — exec_plan 21/21 tasks, 3 phases,
> full workspace verify green + the 3-part acceptance bar (CI assemble-clean + CI golden + local VICE
> `$D020==0xF5` on real 3.10). The `modelToFunctionInfo` seam is closed: new `function-collection.ts`
