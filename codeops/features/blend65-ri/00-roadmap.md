...
|-------|----|-------|-----------|----------|-------|--------|
| 1 | RD-15 | Programmatic + CLI API | RD-01, RD-09, RD-10, RD-11, RD-16 | `codeops/features/blend65-ri/plans/rd-15-programmatic-cli-api/` | A | 🔄 Executing (2026-07-03 — Phases 1–2/4 COMPLETE: 26/50 tasks; host + driver codes + PF-002 rename, then the full `compile`/`emitIl`/`emitAsm`/`build` facade with PF-001 codegen seam, all shipped & verified) |
