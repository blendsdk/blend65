...
|-------|----|-------|-----------|----------|-------|--------|
| 1 | RD-17 | Intrinsics & runtime ABI | RD-04, RD-10 | `codeops/features/blend65-ri/plans/rd-17-intrinsics-runtime-abi/` | A | 🔄 Executing (2026-07-02) — Phase 1/6 complete (8/47 tasks): core registry, catalog & core deltas |
