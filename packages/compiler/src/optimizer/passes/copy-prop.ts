...
import { isSlotOperand, isInlineContinuationLabel } from '../../il/guards.js';
...
export class CopyPropPass implements OptimizationPass {
   ...
   * no external code jumps to them. Copy relationships known before these
   * labels are still valid after, so we propagate through them safely.
   */
