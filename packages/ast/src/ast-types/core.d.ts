 ...
 */
export type Expression = BinaryExpr | UnaryExpr | UpdateExpr | AssignmentExpr | ConditionalExpr | CallExpr | MemberExpr | IndexExpr | Identifier | Literal | ArrayLiteral | RecordLiteral;
/**
 ...
 */
export type Statement = ExpressionStatement | ReturnStatement | IfStatement | WhileStatement | ForStatement | MatchStatement | BlockStatement | BreakStatement | ContinueStatement;
/**
 ...
 */
export type Declaration = FunctionDeclaration | VariableDeclaration | TypeDeclaration | EnumDeclaration;
/**
