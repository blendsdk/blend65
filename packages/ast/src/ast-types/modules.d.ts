...
export type ModuleSystemNode = ModuleDeclaration | ImportDeclaration | ExportDeclaration | ReexportDeclaration | ImportSpecifier | QualifiedName | TargetModule;
