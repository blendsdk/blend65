...
function updateSnake(): void
  // Game logic
            ...
            expect(program.body[1].storageClass).toBe('zp');
            expect(program.body[2].storageClass).toBe('ram');
            expect(program.body[3].storageClass).toBe('const');
...
function test(): void
  zp var invalid: byte = 5  // Should error with clear message
            ...
            try {
                ...
                expect(error.message).toContain("Storage class 'zp' not allowed inside functions");
...
export function initSprites(): void
  ...
  next sprite
            ...
            // Export should work
            expect(program.exports.length).toBe(1);
            const exportedFunc = program.exports[0].declaration;
...
function processData(): void
  ...
  var defaultResult: byte = defaultValue * 2
            ...
            const vars = program.body.slice(0, 4);
...
//# sourceMappingURL=v01-compatibility.test.js.map