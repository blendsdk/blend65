...
export class TokenStream {
   ...
   */
  previous(offset: number = 1): Token {
   ...
   */
  lookAhead(predicate: (token: Token) => boolean, maxLookAhead: number = 10): number {
   ...
   */
  lookAheadFor(type: TokenType, maxLookAhead: number = 10): number {
   ...
   */
  lookAheadForLexeme(lexeme: string, maxLookAhead: number = 10): number {
   ...
   */
  getContextView(radius: number = 2): string {
