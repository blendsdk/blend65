...
describe('ControlFlowAnalyzer', () => {
    ...
    describe('Basic CFG Construction', () => {
        it('should create CFG for simple function with single basic block', () => {
            ...
            ilFunction.instructions = [
                ...
                createILInstruction(ILInstructionType.RETURN, [createILVariable('result', { kind: 'primitive', name: 'byte' })], 1),
            ];
        ...
        it('should create CFG for function with conditional branches', () => {
            ...
            ilFunction.instructions = [
                createILInstruction(ILInstructionType.LOAD_VARIABLE, [
                    createILVariable('temp', { kind: 'primitive', name: 'byte' }),
                    createILVariable('x', { kind: 'primitive', name: 'byte' }),
                ], 0),
                createILInstruction(ILInstructionType.BRANCH_IF_TRUE, [
                    createILVariable('temp', { kind: 'primitive', name: 'byte' }),
                ...
                createILInstruction(ILInstructionType.RETURN, [createILVariable('result', { kind: 'primitive', name: 'byte' })], 5),
            ];
        ...
        it('should create CFG for function with loops', () => {
            ...
            ilFunction.instructions = [
                ...
                createILInstruction(ILInstructionType.COMPARE_LT, [
                    createILVariable('temp', { kind: 'primitive', name: 'byte' }),
                    createILVariable('i', { kind: 'primitive', name: 'byte' }),
                    createILConstant({ kind: 'primitive', name: 'byte' }, 10),
                ], 1),
                createILInstruction(ILInstructionType.BRANCH_IF_FALSE, [
                    createILVariable('temp', { kind: 'primitive', name: 'byte' }),
    ...
    describe('Loop Analysis', () => {
        ...
        it('should classify loop characteristics correctly', () => {
            ...
            ilFunction.instructions = [
                ...
                createILInstruction(ILInstructionType.LOAD_ARRAY, [
                ...
                createILInstruction(ILInstructionType.CALL, [
                    createILVariable('result', { kind: 'primitive', name: 'byte' }),
    ...
    describe('Data Dependency Analysis', () => {
        it('should extract variable definitions correctly', () => {
            ...
            ilFunction.instructions = [
                ...
                createILInstruction(ILInstructionType.STORE_VARIABLE, [
    ...
    describe('Performance Validation', () => {
        it('should complete analysis within performance targets', () => {
            ...
            const instructions = [];
            for (let i = 0; i < 50; i++) {
                instructions.push(createILInstruction(ILInstructionType.ADD, [
                    createILVariable(`var${i}`, { kind: 'primitive', name: 'byte' }),
                    createILVariable(`var${i}`, { kind: 'primitive', name: 'byte' }),
                    createILConstant({ kind: 'primitive', name: 'byte' }, 1),
                ], i));
            }
            instructions.push(createILInstruction(ILInstructionType.RETURN, [createILVariable('var49', { kind: 'primitive', name: 'byte' })], 50));
        ...
        it('should handle memory usage efficiently', () => {
            ...
            const instructions = [];
            for (let i = 0; i < 100; i++) {
                instructions.push(createILInstruction(ILInstructionType.LOAD_IMMEDIATE, [
                    createILVariable(`var${i}`, { kind: 'primitive', name: 'byte' }),
                    createILConstant({ kind: 'primitive', name: 'byte' }, i),
                ], i));
            }
            instructions.push(createILInstruction(ILInstructionType.RETURN, [createILVariable('var99', { kind: 'primitive', name: 'byte' })], 100));
            ilFunction.instructions = instructions;
            const result = analyzer.analyzeFunction(ilFunction);
    ...
    describe('Edge Cases and Error Handling', () => {
        ...
        it('should handle complex control flow patterns', () => {
            ...
            ilFunction.instructions = [
                ...
                createILInstruction(ILInstructionType.COMPARE_EQ, [
...
//# sourceMappingURL=control-flow-analyzer.test.js.map