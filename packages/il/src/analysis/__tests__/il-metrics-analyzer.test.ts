...
describe('ILMetricsAnalyzer', () => {
  ...
  let mockILFunction: ILFunction;
  let mockCFGAnalysis: ControlFlowAnalysisResult;
  let mockSixtyTwo6502Analysis: SixtyTwo6502ValidationResult;

  beforeEach(() => {
    analyzer = new ILMetricsAnalyzer();

    // Create mock IL function
    mockILFunction = createILFunction(
      'testFunction',
      ['test'],
  ...
  describe('Basic Functionality', () => {
    ...
    it('should create analyzer with custom options', () => {
      const options: Partial<QualityAnalysisOptions> = {
