...
export class LibraryLoader {
   ...
   * In v2: `packages/compiler-v2/library/`
   */
  ...
  constructor(libraryPath?: string) {
    if (libraryPath) {
      ...
      // This file: packages/compiler-v2/src/library/loader.ts (or dist/library/loader.js)
      // Library dir: packages/compiler-v2/library/
