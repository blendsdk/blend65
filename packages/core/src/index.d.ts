...
export type { SourceFile, CompilationError, CompilationResult, CompilationStatistics, CompilationErrorType, ProjectConfig, FileStatus, } from './types.js';
export { createSourceFile, createCompilationError, createDefaultProjectConfig, validateProjectConfig, matchesPatterns, getFileExtension, isBlend65File, normalizePath, } from './types.js';
/**
