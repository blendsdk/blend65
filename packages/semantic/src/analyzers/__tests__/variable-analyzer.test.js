...
import { createPrimitiveType, createArrayType, createVariableSymbol, } from '../../types';
import { createExpressionContext } from '../expression-analyzer.js';
describe('VariableAnalyzer', () => {
    let symbolTable;
    let typeChecker;
    let variableAnalyzer;
    const mockLocation = { line: 1, column: 1, offset: 0 };
    let mockSymbolLookup;
    beforeEach(() => {
        symbolTable = new SymbolTable();
        mockSymbolLookup = (name) => symbolTable.lookupSymbol(name);
    ...
    describe('Basic Variable Declaration Analysis', () => {
        it('should analyze simple byte variable declaration', () => {
            ...
            if (result.success) {
                ...
                expect(result.data.varType.name).toBe('byte');
        ...
        it('should analyze word variable with initialization', () => {
            ...
            if (result.success) {
                ...
                expect(result.data.varType.name).toBe('word');
            }
        });
        it('should analyze array variable declaration', () => {
            ...
            if (result.success) {
                ...
                expect(result.data.varType.size).toBe(256);
            }
        });
    ...
    describe('Statistics and Analysis', () => {
        it('should provide comprehensive analysis statistics', () => {
            ...
            const vars = [
                { name: 'zpVar', storageClass: 'zp' },
                { name: 'ramVar', storageClass: 'ram' },
    ...
    describe('Task 1.8: Enhanced Variable Usage Analysis', () => {
        ...
        describe('Zero Page Promotion Analysis', () => {
            ...
            it('should reject variables already in zero page', () => {
                ...
                expect(playerXCandidate.antiPromotionFactors).toContainEqual(expect.objectContaining({
                    factor: 'already_zp',
                    weight: 100,
            ...
            it('should reject I/O variables', () => {
                ...
                expect(ioCandidate.antiPromotionFactors).toContainEqual(expect.objectContaining({
                    factor: 'io_access',
                    weight: 100,
        ...
        describe('Integration with Expression Analysis', () => {
            ...
            it('should aggregate multiple references to the same variable', () => {
                ...
                const multipleRefsResults = [
                    {
                        expression: { type: 'Identifier', name: 'counter' },
                        resolvedType: createPrimitiveType('byte'),
                        optimizationData: {
                            usedVariables: [
                                {
                ...
                const malformedResults = [
                    {
                        ...
                        optimizationData: {
                            usedVariables: [
                                {
                                    symbol: { name: 'nonexistent' }, // Invalid symbol
                                    accessType: 'read',
                                    location: mockLocation,
 ...
 */
//# sourceMappingURL=variable-analyzer.test.js.map