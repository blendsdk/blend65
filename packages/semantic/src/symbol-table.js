 ...
 */
import { createScope, } from './types.js';
// ============================================================================
...
export class SymbolTable {
     ...
     */
    lookupSymbolInScope(name, scope) {
     ...
     */
    lookupQualifiedSymbol(qualifiedName) {
     ...
     */
    importSymbol(importInfo, location) {
        const currentModule = this.getCurrentModule();
        if (!currentModule) {
            const error = {
                errorType: 'InvalidScope',
     ...
     */
    checkShadowing(symbolName, location) {
     ...
     */
    getMaxScopeDepth(scope, currentDepth) {
 ...
 */
export function validateSymbolTable(symbolTable) {
    const errors = [];
