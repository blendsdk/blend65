...
export { 
// Core type factories
createPrimitiveType, createArrayType, createNamedType, createCallbackType, 
// Symbol factories
createVariableSymbol, createFunctionSymbol, createModuleSymbol, createScope, 
// Type checking utilities
isAssignmentCompatible, areTypesEqual, areCallbackTypesCompatible, typeToString, validateStorageClassUsage, 
// Type guards
isVariableSymbol, isFunctionSymbol, isModuleSymbol, isTypeSymbol, isEnumSymbol, isPrimitiveType, isArrayType, isNamedType, isCallbackType, } from './types.js';
// Symbol table exports
export { SymbolTable, createSymbolTable, validateSymbolTable, } from './symbol-table.js';
// Type system exports
export { TypeChecker } from './type-system.js';
