...
describe('SymbolTable', () => {
  ...
  describe('Symbol Lookup', () => {
    let varSymbol: VariableSymbol;
    let funcSymbol: FunctionSymbol;

    beforeEach(() => {
      varSymbol = createVariableSymbol(
        'globalVar',
        createPrimitiveType('byte'),
        symbolTable.getCurrentScope(),
        mockLocation
      ...
      funcSymbol = createFunctionSymbol(
        'globalFunc',
        [],
    ...
    it('should handle symbol shadowing correctly', () => {
      ...
      const localVar = createVariableSymbol(
        'globalVar', // Same name as global variable
        createPrimitiveType('word'),
        symbolTable.getCurrentScope(),
        { line: 2, column: 1, offset: 10 }
      );
  ...
  describe('Module System', () => {
    let gameModule: ModuleSymbol;
    let utilsModule: ModuleSymbol;

    beforeEach(() => {
      gameModule = createModuleSymbol(
        'Game',
        ['Game'],
        symbolTable.getCurrentScope(),
        mockLocation
    ...
    it('should export symbols from modules', () => {
      ...
      const exportedVar = createVariableSymbol(
        'playerScore',
        createPrimitiveType('word'),
        symbolTable.getCurrentScope(),
        mockLocation
    ...
    it('should prevent exports outside module scope', () => {
      const globalVar = createVariableSymbol(
        'globalVar',
        createPrimitiveType('byte'),
        symbolTable.getCurrentScope(),
        mockLocation
    ...
    it('should detect duplicate exports', () => {
      ...
      const var1 = createVariableSymbol(
        'sharedVar',
        createPrimitiveType('byte'),
        symbolTable.getCurrentScope(),
        mockLocation
      ...
      const var2 = createVariableSymbol(
        'sharedVar',
        createPrimitiveType('word'),
        symbolTable.getCurrentScope(),
        { line: 2, column: 1, offset: 10 }
    ...
    it('should import symbols from other modules', () => {
      ...
      const utilityFunc = createFunctionSymbol(
        'randomByte',
        [],
        createPrimitiveType('byte'),
        symbolTable.getCurrentScope(),
  ...
  describe('Callback Function Support', () => {
    it('should handle callback function symbols', () => {
      const callbackFunc = createFunctionSymbol(
        'onInterrupt',
        [],
        createPrimitiveType('void'),
        symbolTable.getCurrentScope(),
    ...
    it('should handle callback type variables', () => {
      const callbackVar = createVariableSymbol(
        'interruptHandler',
        createCallbackType([], createPrimitiveType('void')),
        symbolTable.getCurrentScope(),
        mockLocation
      );
  ...
  describe('Complex Scenarios', () => {
    it('should handle realistic multi-module scenario', () => {
      ...
      const utilsModule = createModuleSymbol(
        'Utils',
        ['Utils'],
        symbolTable.getCurrentScope(),
        mockLocation
      ...
      const randomFunc = createFunctionSymbol(
        'random',
        [],
        createPrimitiveType('byte'),
        symbolTable.getCurrentScope(),
      ...
      const updateFunc = createFunctionSymbol(
        'updateGame',
        [],
        createPrimitiveType('void'),
        symbolTable.getCurrentScope(),
        { line: 12, column: 1, offset: 120 }
      );
