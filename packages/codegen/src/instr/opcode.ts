/**
 * Re-export shim — the 6502 opcode model now lives in `@blend65/core`. This
 * file preserves the historical `./opcode.js` import path used across
 * `instr/` so existing code and tests resolve unchanged **by value**.
 *
