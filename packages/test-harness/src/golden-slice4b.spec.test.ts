/**
 * CI golden test for the RD-18 Slice 4b fixture (acceptance bar part 2): emits the
 ...
 *
 * Derived from `03-03-acceptance-fixtures.md` (ST-20). The golden pins the exact
