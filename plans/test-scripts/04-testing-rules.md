# Testing Rules Specification: .clinerules/testing.md

> **Document**: 04-testing-rules.md
> **Parent**: [Index](00-index.md)

## Overview

This document specifies the content for `.clinerules/testing.md`, which will be the single source of truth for all testing rules that AI agents must follow.

## Target File

**Location:** `.clinerules/testing.md`
...
- `.clinerules/agents.md` - For shell command rules
- `.clinerules/project.md` - For project test commands
- `.clinerules/code.md` - For testing requirements